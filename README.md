...
We will then shift our focus to the Transformer architecture, implementing a computationally efficient variant of it.
...
- The text and code cells in these notebooks are intended to guide you through the
  ...
  The notebooks **do not need to be edited** except for checkpoint management (unless you wish to play around).
